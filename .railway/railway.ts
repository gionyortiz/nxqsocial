...
export default defineRailway((ctx) => {
  ...
  const backend = service("backend", {
    ...
    env: {
      ...
      AWS_REGION: "auto",
      REKOGNITION_REGION: shared.REKOGNITION_REGION,
      REKOGNITION_ACCESS_KEY_ID: shared.REKOGNITION_ACCESS_KEY_ID,
      REKOGNITION_SECRET_ACCESS_KEY: shared.REKOGNITION_SECRET_ACCESS_KEY,
      REKOGNITION_S3_BUCKET: "nxqsocial-staging-moderation-private",
